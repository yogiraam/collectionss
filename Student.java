...
public class Student implements Comparable<Student>{
	...
	private List<Subject> allSubjects;//subjects are stored in arrays so that we use list instead of arrays
	...
	public void setAllCertificates(List<Certificate> allCertificates) {
