...
//this method info about desired info
	...
	//this method takes student info at the student list

	public Student addStudentMarks(Student student, List<Subject> subjects)// List<Subject> subjects
	{


			student.setAllSubjects(subjects);//allign list of marks with the particular student
			return student;  //method returns student with marks inside it

	}
	public Student addStudentCertificates(Student student,List<Certificate> certificates)
	{
	...
	{
		List<Student> allStudentsOfState = colg.get(state);
		return allStudentsOfState;

	}
	public List<Student> getStudentByCertificate(String certificate)
	{
		List<Student> allStudentsOfCertificate = colg.get(certificate);
		return allStudentsOfCertificate;
